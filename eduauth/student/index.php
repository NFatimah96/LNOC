...
if(isset($_POST['login'])) 
  {
    ...
    $sql ="SELECT ID FROM tblstudent WHERE UserName=:username and Password=:password";
...
<html lang="en">
  <head>
    ...
    <title>Learn Nest Student Management System|| Login Page</title>
    <!-- plugins:css -->
          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-center p-5">
                <div class="">
                  <!-- <img src="assets/images/coverLogo.png"> -->
                  <img class="logo-size" src="assets/images/Logo.png">
                  <!-- <img src="assets/images/Logo 10.png"> -->
                  <!-- <h3 class="brand-name">Learn Nest Online Coaching</h3> -->
                </div>
                <h5 class="heading1">Hello! let's get started</h5>

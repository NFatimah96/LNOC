...
if (strlen($_SESSION['sturecmsaid']==0)) {
 ...
 $ret="select UserName from tblteacher where UserName=:uname || TchID=:tchid";
...
$sql="insert into tblteacher(TeacherName,TeacherEmail,TeacherClass,Gender,DOB,TchID,FatherName,MotherName,ContactNumber,AltenateNumber,Address,UserName,Password,Image)values(:tchname,:tchemail,:tchclass,:gender,:dob,:tchid,:fname,:mname,:connum,:altconnum,:address,:uname,:password,:image)";
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample row" method="post" enctype="multipart/form-data" >
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input type="text" name="tchname" value="" class="form-control" required='true'>
                      </div>
                      <div class="form-group col-md-6">
                        <label for="exampleInputName1">Teacher Email</label>
                        <input type="text" name="tchemail" value="" class="form-control" required='true'>
                      </div>
                      <div class="form-group col-md-6">
...
<option value="<?php echo htmlentities($row1->ID);?>"><?php echo htmlentities($row1->ClassName);?> <?php echo htmlentities($row1->Section);?></option>
 <?php } ?> 
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input type="text" name="tchid" value="" class="form-control" required='true'>
                      </div>
                      <div class="form-group col-md-6">
